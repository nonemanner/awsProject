...
create table exts (id bigint not null auto_increment, created_date datetime, modified_date datetime, custom_yn varchar(255), default_yn varchar(255), name varchar(20) not null, use_yn varchar(255), primary key (id)) engine=InnoDB
